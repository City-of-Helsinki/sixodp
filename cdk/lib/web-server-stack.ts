...
export class WebServerStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: WebServerStackProps) {
        ...
        webServerUserData.addCommands(
            ...
            'cd /root',
            'git clone https://github.com/City-of-Helsinki/sixodp.git',
            'cd /root/sixodp',
            'git submodule update --init --recursive',
            `aws s3 cp s3://sixodp-helsinki-secrets/${props.environment}/secrets.yml /root/sixodp-secrets/${props.environment}/secrets.yml`,
