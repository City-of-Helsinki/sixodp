...
<div id="primary" class="content-area">
  <main id="main" class="site-main site-main--home" role="main">
    ...
    <div id="maincontent" class="page-content container centered-content">
      ...
      if (sizeof($updates) == 0) { ?>
        <h2 class="heading-sidebar text-center"><?php echo sprintf(__('No updates found between %1$s and %2$s.', 'sixodp'), $date, date('d.m.Y', strtotime($date ."+2 week"))); ?></h2>
      <?php } else { ?>
          <h2 class="heading-sidebar text-center"><?php echo sprintf(__('Updates between %1$s and %2$s.', 'sixodp'), $date, date('d.m.Y', strtotime($date ."+2 week"))); ?></h2>
      <ul class="items-list">
